...
fun ImageView.loadImage(@DrawableRes resId: Int,context: Context) = Glide.with(context).load(resId).into(this)
fun ImageView.loadImage(url: String,context: Context) = Glide.with(context).load(url).into(this)
