package com.orcas.data.api.interceptors
...
import com.orcas.data.network.api.interceptors.ApiKeyInterceptor
...
class ApiKeyInterceptorTest {
    ...
    fun `Add query param to request OK`() = runBlocking(Dispatchers.Main) {
        ...
        Mockito.`when`(BuildConfig.API_KEY).thenReturn("my_api_key_value")
